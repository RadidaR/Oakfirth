	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 Final_VertexPosition890_g64743 = ( VertexPosition3588_g64743 + _DisableSRPBatcher );
				
				float2 vertexToFrag11_g64879 = ( ( v.texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord8.xy = vertexToFrag11_g64879;
				float2 lerpResult1545_g64743 = lerp( v.texcoord.xy , v.texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g64743 = lerpResult1545_g64743;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float2 staticSwitch3466_g64743 = (ase_worldPos).xz;
				#else
				float2 staticSwitch3466_g64743 = lerpResult1545_g64743;
				#endif
				float2 vertexToFrag11_g64813 = ( ( staticSwitch3466_g64743 * (_SecondUVs).xy ) + (_SecondUVs).zw );
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float lerpResult1537_g64743 = lerp( Main_Normal_WS4101_g64743.y , -Main_Normal_WS4101_g64743.y , _DetailProjectionMode);
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float staticSwitch3467_g64743 = temp_output_3919_0_g64743;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float staticSwitch3467_g64743 = ( ( lerpResult1537_g64743 * 0.5 ) + _DetailMeshValue );
				#else
				float staticSwitch3467_g64743 = temp_output_3919_0_g64743;
				#endif
				half Blend_Source1540_g64743 = staticSwitch3467_g64743;
				...
				half Main_Metallic237_g64743 = ( tex2DNode35_g64743.r * _MainMetallicValue );
				half Second_Metallic226_g64743 = ( tex2DNode33_g64743.r * _SecondMetallicValue );
				float lerpResult278_g64743 = lerp( Main_Metallic237_g64743 , Second_Metallic226_g64743 , Mask_Detail147_g64743);
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch299_g64743 = Main_Metallic237_g64743;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch299_g64743 = lerpResult278_g64743;
				#else
				float staticSwitch299_g64743 = Main_Metallic237_g64743;
				#endif
				half Blend_Metallic306_g64743 = staticSwitch299_g64743;
				float lerpResult342_g64743 = lerp( Blend_Metallic306_g64743 , 0.0 , Overlay_Mask269_g64743);
				half Final_Metallic367_g64743 = lerpResult342_g64743;
				...
				float3 Specular = 0.5;
				float Metallic = Final_Metallic367_g64743;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 lerpResult1545_g64743 = lerp( v.texcoord0.xy , v.texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g64743 = lerpResult1545_g64743;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 lerpResult1545_g64743 = lerp( v.ase_texcoord.xy , v.ase_texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g64743 = lerpResult1545_g64743;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float lerpResult4755_g64743 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g64876 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g64876 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g64880 = lerpResult4755_g64743;
				o.ase_texcoord6.x = vertexToFrag11_g64880;
				float3 vertexToFrag3890_g64743 = ase_worldPos;
				o.ase_texcoord6.yzw = vertexToFrag3890_g64743;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float localCustomAlphaClip9_g64873 = ( 0.0 );
				float vertexToFrag11_g64880 = IN.ase_texcoord6.x;
				half Fade_Camera3743_g64743 = vertexToFrag11_g64880;
				float temp_output_41_0_g64856 = ( 1.0 * Fade_Camera3743_g64743 );
				float3 vertexToFrag3890_g64743 = IN.ase_texcoord6.yzw;
				float3 WorldPosition3905_g64743 = vertexToFrag3890_g64743;
				half Final_AlphaFade3727_g64743 = saturate( ( temp_output_41_0_g64856 + ( temp_output_41_0_g64856 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g64743 ) ).r ) ) );
				float4 tex2DNode29_g64743 = tex2D( _MainAlbedoTex, Main_UVs15_g64743 );
				float Main_Alpha316_g64743 = ( _MainColor.a * tex2DNode29_g64743.a );
...
/*ASEBEGIN
Version=18934
1920;6;1920;1023;2552.487;1094.213;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;343;-2176,384;Inherit;False;Define Shader Object;-1;;64888;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;397;-1920,384;Inherit;False;Define Pipeline Universal;-1;;64887;71dc7add32e5f6247b1fb74ecceddd3e;0;0;1;FLOAT;529
...
Node;AmplifyShaderEditor.FunctionNode;399;-1536,-896;Inherit;False;Compile Core;-1;;64886;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;382;-2176,-384;Inherit;False;Base Shader;0;;64743;856f7164d1c579d43a5cf4968a75ca43;77,3880,1,4029,1,4028,1,4204,1,3900,1,3904,1,3903,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,4499,0,3658,0,1708,0,3509,1,1712,0,3873,1,893,0,4544,1,1718,1,1715,1,1717,1,1714,1,916,1,1762,0,1763,0,3568,1,1949,1,1776,0,3475,1,4210,1,1745,0,3479,0,4510,0,3501,0,3221,2,1646,0,1271,0,3889,1,2807,0,3886,0,2953,0,3887,0,3243,0,3888,0,3957,1,2172,0,3883,0,3728,1,3949,0,4781,0,2658,0,1742,0,3484,0,1737,1,1733,1,1735,1,1736,1,3575,1,4837,1,1734,1,878,1,1550,1,860,0,2260,1,2261,1,2032,1,2054,1,2039,1,2062,1,4177,1,4217,1,3592,1,4242,0,2750,0;0;20;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534;FLOAT;4867;FLOAT4;4841
Node;AmplifyShaderEditor.RangedFloatNode;404;-1408,-768;Half;False;Property;_render_coverage;_render_coverage;209;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;398;-1344,-896;Inherit;False;Compile All Shaders;-1;;64742;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6054030D7F04B3A5C81F890FD65741DFC401226D
