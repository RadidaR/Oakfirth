	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 Vertex_Motion_Object833_g64743 = ( ( ( VertexPosRotationAxis50_g64810 + ( VertexPosOtherAxis82_g64810 * cos( Angle44_g64810 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g64810 ) * sin( Angle44_g64810 ) ) ) + Motion_20_Vertical4280_g64743 + Motion_20_Squash4418_g64743 ) + Motion_30_Details263_g64743 );
				...
				float3 Vertex_Motion_World1118_g64743 = ( ( ( temp_output_3474_0_g64743 + appendResult2043_g64743 ) + appendResult2047_g64743 + Motion_20_Vertical4280_g64743 + Motion_20_Squash4418_g64743 ) + Motion_30_Details263_g64743 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				o.ase_texcoord9.w = vertexToFrag11_g64816;
				...
				o.ase_texcoord10.w = vertexToFrag11_g64880;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				half Overlay_Mask269_g64743 = saturate( ( ( ( ( ( lerpResult3567_g64743 * 0.5 ) + Main_AlbedoTex_G3526_g64743 ) * Overlay_Commons1365_g64743 ) - temp_output_7_0_g64869 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g64869 ) ) );
				...
				float vertexToFrag11_g64816 = IN.ase_texcoord9.w;
				float3 lerpResult2945_g64743 = lerp( (_VertexOcclusionColor).rgb , temp_cast_6 , vertexToFrag11_g64816);
				...
				float dotResult3851_g64743 = dot( ViewDir_Normalized3963_g64743 , NormalsWS_Derivates3972_g64743 );
				float lerpResult3993_g64743 = lerp( 1.0 , saturate( abs( dotResult3851_g64743 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g64743 = lerpResult3993_g64743;
				float vertexToFrag11_g64880 = IN.ase_texcoord10.w;
				half Fade_Camera3743_g64743 = vertexToFrag11_g64880;
				float temp_output_41_0_g64856 = ( Fade_Glancing3853_g64743 * Fade_Camera3743_g64743 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_3377_0_g64743 = saturate( ( ( Mesh_Occlusion318_g64743 - temp_output_7_0_g64821 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g64821 ) ) );
				float vertexToFrag11_g64816 = temp_output_3377_0_g64743;
				o.ase_texcoord5.w = vertexToFrag11_g64816;
				...
				float lerpResult4755_g64743 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g64876 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g64876 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g64880 = lerpResult4755_g64743;
				o.ase_texcoord6.w = vertexToFrag11_g64880;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Final_Albedo359_g64743 = lerpResult336_g64743;
				float3 temp_cast_6 = (1.0).xxx;
				float vertexToFrag11_g64816 = IN.ase_texcoord5.w;
				float3 lerpResult2945_g64743 = lerp( (_VertexOcclusionColor).rgb , temp_cast_6 , vertexToFrag11_g64816);
				float3 Vertex_Occlusion648_g64743 = lerpResult2945_g64743;
				...
				float lerpResult3993_g64743 = lerp( 1.0 , saturate( abs( dotResult3851_g64743 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g64743 = lerpResult3993_g64743;
				float vertexToFrag11_g64880 = IN.ase_texcoord6.w;
				half Fade_Camera3743_g64743 = vertexToFrag11_g64880;
				float temp_output_41_0_g64856 = ( Fade_Glancing3853_g64743 * Fade_Camera3743_g64743 );
				half Final_AlphaFade3727_g64743 = saturate( ( temp_output_41_0_g64856 + ( temp_output_41_0_g64856 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g64743 ) ).r ) ) );
				float Main_Alpha316_g64743 = ( _MainColor.a * tex2DNode29_g64743.a );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_3377_0_g64743 = saturate( ( ( Mesh_Occlusion318_g64743 - temp_output_7_0_g64821 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g64821 ) ) );
				float vertexToFrag11_g64816 = temp_output_3377_0_g64743;
				o.ase_texcoord3.w = vertexToFrag11_g64816;
				
				float temp_output_7_0_g64876 = TVE_CameraFadeStart;
				float lerpResult4755_g64743 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g64876 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g64876 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g64880 = lerpResult4755_g64743;
				o.ase_texcoord4.w = vertexToFrag11_g64880;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Final_Albedo359_g64743 = lerpResult336_g64743;
				float3 temp_cast_6 = (1.0).xxx;
				float vertexToFrag11_g64816 = IN.ase_texcoord3.w;
				float3 lerpResult2945_g64743 = lerp( (_VertexOcclusionColor).rgb , temp_cast_6 , vertexToFrag11_g64816);
				float3 Vertex_Occlusion648_g64743 = lerpResult2945_g64743;
				...
				float lerpResult3993_g64743 = lerp( 1.0 , saturate( abs( dotResult3851_g64743 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g64743 = lerpResult3993_g64743;
				float vertexToFrag11_g64880 = IN.ase_texcoord4.w;
				half Fade_Camera3743_g64743 = vertexToFrag11_g64880;
				float temp_output_41_0_g64856 = ( Fade_Glancing3853_g64743 * Fade_Camera3743_g64743 );
				half Final_AlphaFade3727_g64743 = saturate( ( temp_output_41_0_g64856 + ( temp_output_41_0_g64856 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g64743 ) ).r ) ) );
				float Main_Alpha316_g64743 = ( _MainColor.a * tex2DNode29_g64743.a );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float lerpResult4755_g64743 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g64876 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g64876 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g64880 = lerpResult4755_g64743;
				o.ase_texcoord4.z = vertexToFrag11_g64880;
				o.ase_texcoord5.xyz = vertexToFrag3890_g64743;
				o.ase_texcoord6.xyz = vertexToFrag4224_g64743;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float lerpResult3993_g64743 = lerp( 1.0 , saturate( abs( dotResult3851_g64743 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g64743 = lerpResult3993_g64743;
				float vertexToFrag11_g64880 = IN.ase_texcoord4.z;
				half Fade_Camera3743_g64743 = vertexToFrag11_g64880;
				float temp_output_41_0_g64856 = ( Fade_Glancing3853_g64743 * Fade_Camera3743_g64743 );
				float3 vertexToFrag3890_g64743 = IN.ase_texcoord5.xyz;
				float3 WorldPosition3905_g64743 = vertexToFrag3890_g64743;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float lerpResult3993_g64743 = lerp( 1.0 , saturate( abs( dotResult3851_g64743 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g64743 = lerpResult3993_g64743;
				float vertexToFrag11_g64880 = IN.ase_texcoord.w;
				half Fade_Camera3743_g64743 = vertexToFrag11_g64880;
				float temp_output_41_0_g64856 = ( Fade_Glancing3853_g64743 * Fade_Camera3743_g64743 );
				...
				float temp_output_4023_0_g64743 = (Mesh_Variation16_g64743*0.5 + 0.5);
				float4 temp_output_93_19_g64789 = TVE_ExtrasCoords;
				float3 vertexToFrag4224_g64743 = IN.ase_texcoord3.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g64743;
				half3 WorldData19_g64855 = vertexToFrag3890_g64743;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
...
/*ASEBEGIN
Version=18934
1920;6;1920;1023;2579.735;1125.428;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1025;-1536,-768;Inherit;False;Compile Core;-1;;64887;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1024;-1344,-768;Inherit;False;Compile All Shaders;-1;;64886;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-2176,-640;Half;False;Property;_render_cull;_render_cull;205;1;[HideInInspector];Create;True;0;3;Both;0;Back;1;Front;2;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;471;-2176,512;Inherit;False;Define Shader Vegetation;-1;;64742;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1008;-2177,-257;Inherit;False;Base Shader;0;;64743;856f7164d1c579d43a5cf4968a75ca43;77,3880,1,4029,1,4028,1,4204,1,3900,1,3904,1,3903,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,4499,1,3658,1,1708,1,3509,1,1712,2,3873,1,893,1,4544,1,1718,1,1715,1,1717,1,1714,1,916,1,1762,0,1763,0,3568,1,1949,1,1776,1,3475,1,4210,1,1745,1,3479,0,4510,0,3501,1,3221,2,1646,0,1271,1,3889,0,2807,1,3886,0,2953,1,3887,0,3243,0,3888,0,3957,1,2172,1,3883,0,3728,1,3949,0,4781,0,2658,0,1742,0,3484,0,1737,0,1733,0,1735,0,1736,0,3575,0,4837,0,1734,0,878,0,1550,0,860,1,2260,1,2261,1,2032,1,2054,1,2039,1,2062,1,4177,1,4217,1,3592,1,4242,0,2750,0;0;20;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534;FLOAT;4867;FLOAT4;4841
...
Node;AmplifyShaderEditor.RangedFloatNode;822;-1984,-768;Half;False;Property;_IsSubsurfaceShader;_IsSubsurfaceShader;204;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1030;-1408,-640;Half;False;Property;_render_coverage;_render_coverage;208;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;168;-2176,-768;Half;False;Property;_IsLeafShader;_IsLeafShader;203;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
...
WireConnection;1016;15;1008;1230
WireConnection;1016;8;1008;534
ASEEND*/
//CHKSM=A04F238F6A1C0CB5140A2FB0E1E0C5CE47EE0C00
