	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 appendResult60_g64827 = (float3(v.texcoord.z , 0.0 , v.texcoord.w));
				half3 Mesh_PivotsData2831_g64743 = ( appendResult60_g64827 * _VertexPivotMode );
				half3 Mesh_PivotsOS2291_g64743 = Mesh_PivotsData2831_g64743;
				...
				float4x4 break19_g64859 = GetObjectToWorldMatrix();
				float3 appendResult20_g64859 = (float3(break19_g64859[ 0 ][ 3 ] , break19_g64859[ 1 ][ 3 ] , break19_g64859[ 2 ][ 3 ]));
				float3 appendResult60_g64861 = (float3(v.texcoord.z , 0.0 , v.texcoord.w));
				...
				half3 ObjectData20_g64860 = ( appendResult20_g64859 + PivotsOnly105_g64859 );
				...
				float3 vertexToFrag4224_g64743 = temp_output_114_0_g64859;
				...
				float Motion_Variation330_g64826 = ( _MotionVariation_32 * Motion_Variation3073_g64743 );
				float Bounds_Radius121_g64743 = _MaxBoundsInfo.x;
				half Input_Amplitude58_g64826 = ( _MotionAmplitude_32 * Bounds_Radius121_g64743 * 0.1 );
				...
				half Mesh_Motion_30144_g64743 = v.ase_texcoord3.z;
				float temp_output_7_0_g64809 = TVE_MotionFadeEnd;
				half Wind_FadeOut4005_g64743 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g64809 ) / ( TVE_MotionFadeStart - temp_output_7_0_g64809 ) ) );
				half Motion_Selective4260_g64743 = 1.0;
				half Motion_30_Mode2011_g64743 = _MotionValue_30;
				half3 Motion_30_Details263_g64743 = ( temp_output_299_0_g64826 * ( Mesh_Motion_30144_g64743 * Global_MotionPower2223_g64743 * Wind_FadeOut4005_g64743 * Motion_Selective4260_g64743 * Motion_30_Mode2011_g64743 * Global_MotionNoise34_g64743 ) );
				float3 Vertex_Motion_Object833_g64743 = ( ( VertexPosRotationAxis50_g64782 + ( VertexPosOtherAxis82_g64782 * cos( Angle44_g64782 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g64782 ) * sin( Angle44_g64782 ) ) ) + Motion_30_Details263_g64743 );
				...
				float3 Vertex_Motion_World1118_g64743 = ( ( temp_output_3474_0_g64743 + appendResult2043_g64743 ) + Motion_30_Details263_g64743 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				float temp_output_335_0_g64743 = saturate( ( ( ( distance( _WorldSpaceCameraPos , ObjectPosition4223_g64743 ) * ( 1.0 / TVE_DistanceFadeBias ) ) - temp_output_7_0_g64812 ) / ( _SizeFadeStartValue - temp_output_7_0_g64812 ) ) );
				float3 appendResult3482_g64743 = (float3(temp_output_335_0_g64743 , temp_output_335_0_g64743 , temp_output_335_0_g64743));
				float3 lerpResult3556_g64743 = lerp( _Vector5 , appendResult3482_g64743 , _SizeFadeMode);
				half3 ObjectData20_g64815 = lerpResult3556_g64743;
				...
				#endif
				float3 Vertex_SizeFade1740_g64743 = staticSwitch14_g64815;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult2696_g64743 = normalize( ase_worldViewDir );
				float3 break2709_g64743 = cross( normalizeResult2696_g64743 , half3(0,1,0) );
				float3 appendResult2710_g64743 = (float3(-break2709_g64743.z , 0.0 , break2709_g64743.x));
				float3 appendResult2667_g64743 = (float3(v.ase_color.r , 0.5 , v.ase_color.r));
				...
				float saferPower2652_g64743 = abs( Mask_HView2656_g64743 );
				half3 Grass_Perspective2661_g64743 = ( ( ( mul( GetWorldToObjectMatrix(), float4( appendResult2710_g64743 , 0.0 ) ).xyz * _PerspectivePushValue ) + ( (appendResult2667_g64743*2.0 + -1.0) * _PerspectiveNoiseValue ) ) * v.ase_color.a * pow( saferPower2652_g64743 , _PerspectiveAngleValue ) );
				...
				half Noise_Tint2802_g64743 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_12 * WorldPosition3905_g64743 * 0.1 ), 0.0) ).r - temp_output_7_0_g64870 ) / ( _NoiseMaxValue - temp_output_7_0_g64870 ) ) );
				float vertexToFrag11_g64833 = Noise_Tint2802_g64743;
				o.ase_texcoord8.y = vertexToFrag11_g64833;
				half Global_MotionHighlight4860_g64743 = ( (( sin( ( break500_g64882.x + break500_g64882.y ) ) * sin( ( break494_g64882.x + break494_g64882.y ) ) )*0.5 + 0.5) * (( sin( ( break500_g64882.x + break500_g64882.y ) ) * sin( ( break494_g64882.x + break494_g64882.y ) ) )*0.5 + 0.5) );
				half Highlight_Tint3231_g64743 = ( Global_MotionHighlight4860_g64743 * Global_MotionPower2223_g64743 * Wind_FadeOut4005_g64743 * Mesh_Height1524_g64743 );
				float vertexToFrag11_g64828 = Highlight_Tint3231_g64743;
				o.ase_texcoord8.z = vertexToFrag11_g64828;
				float2 vertexToFrag11_g64879 = ( ( v.texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord9.xy = vertexToFrag11_g64879;
				o.ase_texcoord10.xyz = vertexToFrag3890_g64743;
				o.ase_texcoord11.xyz = vertexToFrag4224_g64743;
				...
				o.ase_texcoord8.w = vertexToFrag11_g64816;
				
				float2 vertexToFrag11_g64849 = ( ( v.texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				o.ase_texcoord9.zw = vertexToFrag11_g64849;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float vertexToFrag11_g64828 = IN.ase_texcoord8.z;
				half Leaves_Mask4511_g64743 = 1.0;
				float3 lerpResult4521_g64743 = lerp( float3( 1,1,1 ) , ( lerpResult2779_g64743 * lerpResult2800_g64743 * ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g64828 ) + float3( 1,1,1 ) ) ) , Leaves_Mask4511_g64743);
				float2 vertexToFrag11_g64879 = IN.ase_texcoord9.xy;
				...
				float3 vertexToFrag3890_g64743 = IN.ase_texcoord10.xyz;
				float3 WorldPosition3905_g64743 = vertexToFrag3890_g64743;
				float3 vertexToFrag4224_g64743 = IN.ase_texcoord11.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g64743;
				half3 WorldData19_g64855 = vertexToFrag3890_g64743;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
				...
				float lerpResult3870_g64743 = lerp( 1.0 , IN.ase_color.r , _ColorsVariationValue);
				half Global_Colors_Value3650_g64743 = ( _GlobalColors * lerpResult3870_g64743 );
				float temp_output_7_0_g64858 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g64743 = saturate( ( ( ( 1.0 - IN.ase_color.a ) - temp_output_7_0_g64858 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g64858 ) ) );
				...
				float lerpResult1065_g64743 = lerp( 1.0 , IN.ase_color.r , _OverlayVariationValue);
				half Overlay_Variation4560_g64743 = lerpResult1065_g64743;
				...
				half Overlay_Mask269_g64743 = saturate( ( ( ( ( ( IN.ase_color.a * 0.5 ) + Main_AlbedoTex_G3526_g64743 ) * Overlay_Commons1365_g64743 ) - temp_output_7_0_g64869 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g64869 ) ) );
				...
				float vertexToFrag11_g64816 = IN.ase_texcoord8.w;
				float3 lerpResult2945_g64743 = lerp( (_VertexOcclusionColor).rgb , temp_cast_5 , vertexToFrag11_g64816);
				...
				float2 vertexToFrag11_g64849 = IN.ase_texcoord9.zw;
				...
				half Final_AlphaFade3727_g64743 = 1.0;
				float Main_Alpha316_g64743 = ( _MainColor.a * tex2DNode29_g64743.a );
				float Mesh_Variation16_g64743 = IN.ase_color.r;
				float temp_output_4023_0_g64743 = (Mesh_Variation16_g64743*0.5 + 0.5);
				half Global_Extras_Alpha1033_g64743 = break89_g64789.a;
				float temp_output_4022_0_g64743 = ( temp_output_4023_0_g64743 - ( 1.0 - Global_Extras_Alpha1033_g64743 ) );
				half AlphaTreshold2132_g64743 = _AlphaCutoffValue;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch4017_g64743 = ( temp_output_4022_0_g64743 + AlphaTreshold2132_g64743 );
				#else
				float staticSwitch4017_g64743 = temp_output_4022_0_g64743;
				#endif
				float lerpResult16_g64885 = lerp( 0.0 , _GlobalAlpha , TVE_Enabled);
				float lerpResult4011_g64743 = lerp( 1.0 , staticSwitch4017_g64743 , lerpResult16_g64885);
				half Global_Alpha315_g64743 = saturate( lerpResult4011_g64743 );
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g64743 = ( ( Main_Alpha316_g64743 * Global_Alpha315_g64743 ) - ( AlphaTreshold2132_g64743 - 0.5 ) );
				#else
				float staticSwitch3792_g64743 = ( Main_Alpha316_g64743 * Global_Alpha315_g64743 );
				#endif
				...
				float3 temp_cast_8 = (dotResult3930_g64743).xxx;
				float3 lerpResult3932_g64743 = lerp( temp_output_799_0_g64743 , temp_cast_8 , Global_Colors_Influence3668_g64743);
				...
				half Subsurface_Mask1557_g64743 = saturate( ( ( IN.ase_color.a - temp_output_7_0_g64872 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g64872 ) ) );
				...
				float3 Translucency = Subsurface_Transmission884_g64743;
				#ifdef ASE_DEPTH_WRITE_ON
				float DepthValue = 0;
				#endif
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float3 VertexPosition3588_g64743 = v.vertex.xyz;
				float3 appendResult60_g64827 = (float3(v.ase_texcoord.z , 0.0 , v.ase_texcoord.w));
				half3 Mesh_PivotsData2831_g64743 = ( appendResult60_g64827 * _VertexPivotMode );
				half3 Mesh_PivotsOS2291_g64743 = Mesh_PivotsData2831_g64743;
				float3 temp_output_2283_0_g64743 = ( VertexPosition3588_g64743 - Mesh_PivotsOS2291_g64743 );
				half3 VertexPos40_g64814 = temp_output_2283_0_g64743;
				...
				float4x4 break19_g64859 = GetObjectToWorldMatrix();
				float3 appendResult20_g64859 = (float3(break19_g64859[ 0 ][ 3 ] , break19_g64859[ 1 ][ 3 ] , break19_g64859[ 2 ][ 3 ]));
				float3 appendResult60_g64861 = (float3(v.ase_texcoord.z , 0.0 , v.ase_texcoord.w));
				float3 temp_output_91_0_g64859 = ( appendResult60_g64861 * _vertex_pivot_mode );
				float3 PivotsOnly105_g64859 = (mul( GetObjectToWorldMatrix(), float4( temp_output_91_0_g64859 , 0.0 ) ).xyz).xyz;
				half3 ObjectData20_g64860 = ( appendResult20_g64859 + PivotsOnly105_g64859 );
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 VertexPosition3588_g64743 = v.vertex.xyz;
				float3 appendResult60_g64827 = (float3(v.texcoord0.z , 0.0 , v.texcoord0.w));
				half3 Mesh_PivotsData2831_g64743 = ( appendResult60_g64827 * _VertexPivotMode );
				half3 Mesh_PivotsOS2291_g64743 = Mesh_PivotsData2831_g64743;
				float3 temp_output_2283_0_g64743 = ( VertexPosition3588_g64743 - Mesh_PivotsOS2291_g64743 );
				half3 VertexPos40_g64814 = temp_output_2283_0_g64743;
				...
				float4x4 break19_g64859 = GetObjectToWorldMatrix();
				float3 appendResult20_g64859 = (float3(break19_g64859[ 0 ][ 3 ] , break19_g64859[ 1 ][ 3 ] , break19_g64859[ 2 ][ 3 ]));
				float3 appendResult60_g64861 = (float3(v.texcoord0.z , 0.0 , v.texcoord0.w));
				float3 temp_output_91_0_g64859 = ( appendResult60_g64861 * _vertex_pivot_mode );
				float3 PivotsOnly105_g64859 = (mul( GetObjectToWorldMatrix(), float4( temp_output_91_0_g64859 , 0.0 ) ).xyz).xyz;
				half3 ObjectData20_g64860 = ( appendResult20_g64859 + PivotsOnly105_g64859 );
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				...
				half Highlight_Tint3231_g64743 = ( Global_MotionHighlight4860_g64743 * Global_MotionPower2223_g64743 * Wind_FadeOut4005_g64743 * Mesh_Height1524_g64743 );
				float vertexToFrag11_g64828 = Highlight_Tint3231_g64743;
				o.ase_texcoord4.z = vertexToFrag11_g64828;
				float2 vertexToFrag11_g64879 = ( ( v.texcoord0.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord5.xy = vertexToFrag11_g64879;
				...
				o.ase_texcoord5.zw = vertexToFrag11_g64849;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 lerpResult2800_g64743 = lerp( (_NoiseColorTwo).rgb , (_NoiseColorOne).rgb , vertexToFrag11_g64833);
				float vertexToFrag11_g64828 = IN.ase_texcoord4.z;
				half Leaves_Mask4511_g64743 = 1.0;
				float3 lerpResult4521_g64743 = lerp( float3( 1,1,1 ) , ( lerpResult2779_g64743 * lerpResult2800_g64743 * ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g64828 ) + float3( 1,1,1 ) ) ) , Leaves_Mask4511_g64743);
				float2 vertexToFrag11_g64879 = IN.ase_texcoord5.xy;
				half2 Main_UVs15_g64743 = vertexToFrag11_g64879;
				float4 tex2DNode29_g64743 = tex2D( _MainAlbedoTex, Main_UVs15_g64743 );
				half3 Main_Albedo99_g64743 = ( (_MainColor).rgb * (tex2DNode29_g64743).rgb );
				half3 Blend_Albedo265_g64743 = Main_Albedo99_g64743;
				...
				float4 temp_output_4214_0_g64743 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				float2 vertexToFrag11_g64849 = IN.ase_texcoord5.zw;
				half2 Emissive_UVs2468_g64743 = vertexToFrag11_g64849;
				half Global_Extras_Emissive4203_g64743 = break89_g64789.r;
				float lerpResult4206_g64743 = lerp( 1.0 , Global_Extras_Emissive4203_g64743 , _GlobalEmissive);
				half3 Final_Emissive2476_g64743 = ( (( temp_output_4214_0_g64743 * tex2D( _EmissiveTex, Emissive_UVs2468_g64743 ) )).rgb * lerpResult4206_g64743 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half Highlight_Tint3231_g64743 = ( Global_MotionHighlight4860_g64743 * Global_MotionPower2223_g64743 * Wind_FadeOut4005_g64743 * Mesh_Height1524_g64743 );
				float vertexToFrag11_g64828 = Highlight_Tint3231_g64743;
				o.ase_texcoord2.z = vertexToFrag11_g64828;
				float2 vertexToFrag11_g64879 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord3.xy = vertexToFrag11_g64879;
				o.ase_texcoord4.xyz = vertexToFrag3890_g64743;
				o.ase_texcoord5.xyz = vertexToFrag4224_g64743;
				float Mesh_Occlusion318_g64743 = v.ase_color.g;
				float temp_output_7_0_g64821 = _VertexOcclusionMinValue;
				float temp_output_3377_0_g64743 = saturate( ( ( Mesh_Occlusion318_g64743 - temp_output_7_0_g64821 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g64821 ) ) );
				float vertexToFrag11_g64816 = temp_output_3377_0_g64743;
				o.ase_texcoord2.w = vertexToFrag11_g64816;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 lerpResult2800_g64743 = lerp( (_NoiseColorTwo).rgb , (_NoiseColorOne).rgb , vertexToFrag11_g64833);
				float vertexToFrag11_g64828 = IN.ase_texcoord2.z;
				half Leaves_Mask4511_g64743 = 1.0;
				float3 lerpResult4521_g64743 = lerp( float3( 1,1,1 ) , ( lerpResult2779_g64743 * lerpResult2800_g64743 * ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g64828 ) + float3( 1,1,1 ) ) ) , Leaves_Mask4511_g64743);
				...
				float3 temp_cast_0 = (dotResult3616_g64743).xxx;
				float4 temp_output_91_19_g64865 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g64743 = IN.ase_texcoord4.xyz;
				float3 WorldPosition3905_g64743 = vertexToFrag3890_g64743;
				float3 vertexToFrag4224_g64743 = IN.ase_texcoord5.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g64743;
				half3 WorldData19_g64855 = vertexToFrag3890_g64743;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
				...
				half3 Final_Albedo359_g64743 = lerpResult336_g64743;
				float3 temp_cast_5 = (1.0).xxx;
				float vertexToFrag11_g64816 = IN.ase_texcoord2.w;
				float3 lerpResult2945_g64743 = lerp( (_VertexOcclusionColor).rgb , temp_cast_5 , vertexToFrag11_g64816);
				float3 Vertex_Occlusion648_g64743 = lerpResult2945_g64743;
        ...
        Pass
        {
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				float2 vertexToFrag11_g64879 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord.xy = vertexToFrag11_g64879;
				o.ase_texcoord1.xyz = vertexToFrag3890_g64743;
				o.ase_texcoord2.xyz = vertexToFrag4224_g64743;
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float localCustomAlphaClip9_g64873 = ( 0.0 );
				half Final_AlphaFade3727_g64743 = 1.0;
				float2 vertexToFrag11_g64879 = IN.ase_texcoord.xy;
				half2 Main_UVs15_g64743 = vertexToFrag11_g64879;
				float4 tex2DNode29_g64743 = tex2D( _MainAlbedoTex, Main_UVs15_g64743 );
				float Main_Alpha316_g64743 = ( _MainColor.a * tex2DNode29_g64743.a );
				float Mesh_Variation16_g64743 = IN.ase_color.r;
				...
				float3 WorldPosition3905_g64743 = vertexToFrag3890_g64743;
				float3 vertexToFrag4224_g64743 = IN.ase_texcoord2.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g64743;
				half3 WorldData19_g64855 = vertexToFrag3890_g64743;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
...
/*ASEBEGIN
Version=18934
1920;6;1920;1023;2655.666;932.516;1;True;False
Node;AmplifyShaderEditor.FunctionNode;1041;-1344,-896;Inherit;False;Compile All Shaders;-1;;63677;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1040;-1920,384;Inherit;False;Define Pipeline Universal;-1;;64887;71dc7add32e5f6247b1fb74ecceddd3e;0;0;1;FLOAT;529
...
Node;AmplifyShaderEditor.RangedFloatNode;1010;-1984,-896;Half;False;Property;_IsSubsurfaceShader;_IsSubsurfaceShader;204;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1042;-1536,-896;Inherit;False;Compile Core;-1;;64886;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;713;-2176,384;Inherit;False;Define Shader Grass;-1;;64742;921559c53826c0142ba6e27dd03eaef2;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1047;-1408,-768;Half;False;Property;_render_coverage;_render_coverage;208;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1025;-2176,-384;Inherit;False;Base Shader;0;;64743;856f7164d1c579d43a5cf4968a75ca43;77,3880,1,4029,1,4028,1,4204,1,3900,1,3904,1,3903,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,4499,1,3658,1,1708,1,3509,1,1712,0,3873,1,893,1,4544,1,1718,1,1715,1,1717,1,1714,1,916,0,1762,0,1763,0,3568,1,1949,1,1776,1,3475,1,4210,1,1745,1,3479,0,4510,0,3501,1,3221,1,1646,0,1271,1,3889,0,2807,1,3886,0,2953,1,3887,0,3243,1,3888,0,3957,0,2172,0,3883,0,3728,0,3949,0,4781,0,2658,1,1742,1,3484,0,1737,0,1733,0,1735,0,1736,0,3575,0,4837,0,1734,0,878,0,1550,0,860,1,2260,1,2261,1,2032,0,2054,0,2039,1,2062,1,4177,0,4217,1,3592,1,4242,1,2750,1;0;20;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534;FLOAT;4867;FLOAT4;4841
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1033;-1376,-384;Float;False;True;-1;2;TVEShaderCoreGUI;0;20;BOXOPHOBIC/The Vegetation Engine/Default/Grass Subsurface Lit;28cd5599e02859647ae1798e4fcaef6c;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;1047;True;True;2;True;10;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;4;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;True;True;1;1;True;20;0;True;7;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;False;False;False;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/BOXOPHOBIC/The Vegetation Engine/Fallback;0;0;Standard;40;Workflow;0;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;637860535030774692;  Transmission Shadow;0.5,True,1013;0;Translucency;1;637860535037399992;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;0;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;False;True;True;False;;False;0
...
WireConnection;1033;15;1025;1230
WireConnection;1033;8;1025;534
ASEEND*/
//CHKSM=8ABA833A4FF896B38DEC6B29103679EA3F91A28B
