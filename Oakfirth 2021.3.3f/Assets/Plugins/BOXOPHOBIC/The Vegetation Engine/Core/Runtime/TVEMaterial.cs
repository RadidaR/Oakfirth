    ...
    public class TVEMaterial
    {
        public static void SetMaterialSettings(Material material)
        {
            ...
            if (material.HasProperty("_IsVersion"))
            {
                ...
                if (material.GetInt("_IsVersion") < 640)
                {
            ...
            if (material.HasProperty("_RenderClip"))
            {
                ...
                float cutoff = material.GetFloat("_AlphaCutoffValue");
            ...
            if (material.HasProperty("_AlphaCutoffValue"))
            {
                material.SetFloat("_Cutoff", material.GetFloat("_AlphaCutoffValue"));
            }
