...
namespace TheVegetationEngine
{
    public class TVEMaterialSettings : EditorWindow
    {
        ...
        List<TVEMaterialData> renderSettings = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_AlphaCutoffValue", "Alpha Treshold", -9999, 0, 1, false, false),
        ...
        void GetMaterialProperties()
        {
            for (int i = 0; i < selectedMaterials.Count; i++)
            {
                ...
                for (int d = 0; d < materialData.Count; d++)
                {
                    ...
                    if (material.GetTag("RenderPipeline", false) == "HDRenderPipeline" || material.shader.name.Contains("Standard") || material.shader.name.Contains("Simple"))
                    {
